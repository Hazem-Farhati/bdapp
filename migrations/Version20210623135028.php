...
final class Version20210623135028 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE chart (id INT AUTO_INCREMENT NOT NULL, number INT NOT NULL, date DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE publication (id INT AUTO_INCREMENT NOT NULL, idpuser_id INT DEFAULT NULL, texte LONGTEXT NOT NULL, date DATE NOT NULL, INDEX IDX_AF3C677959A50A1F (idpuser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
